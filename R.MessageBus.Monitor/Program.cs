...
namespace R.MessageBus.Monitor
{
    class Program
    {
        ...
        private static void Start(string[] args)
        {
            ...
            WebAppStart = WebApp.Start<AuditConfig>("http://" + System.Configuration.ConfigurationManager.AppSettings["Host"] + ":" + System.Configuration.ConfigurationManager.AppSettings["Port"]);
